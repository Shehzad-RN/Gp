...
const Manage1 = props => {
  return (
    ...
    >
      ...
      >
        <Text>I AM UNABLE TO LOGIN TO MY ACCOUNT</Text>
      </View>
      <View
        style={{
          height: "1%",
      ...
      >
        <Text>
          You can recover your password using the 'Forgot Password' link in the
          login page. If you are still unable to access your account, then
